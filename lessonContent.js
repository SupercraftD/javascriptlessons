...
let lessonContents={
    "Printing to the Console": {
        ...
        Using console.log() multiple times will print each message on a new line.<br><br>
        Your Task: run the example code below and then print out at least three messages of your own.`,
